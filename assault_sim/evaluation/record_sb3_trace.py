    ...
    *,
    ...
    return {
        ...
        "plan_debug": {
            ...
            "stuck_steps": int(info.get("plan_stuck_steps", 0) or 0),
            "last_progress": int(info.get("plan_last_progress", 0) or 0),
            "planned_target": info.get("plan_planned_target"),
            "last_failure_reason": info.get("plan_last_failure_reason"),
            "team_focus_vp_id": info.get("plan_team_focus_vp_id"),
            "team_turn_plan_progress": int(info.get("plan_team_turn_plan_progress", 0) or 0),
            "team_units_committed": int(info.get("plan_team_units_committed", 0) or 0),
            "advanced_enabled": bool(info.get("plan_advanced_enabled", False)),
            "advanced_horizon": int(info.get("plan_advanced_horizon", 0) or 0),
